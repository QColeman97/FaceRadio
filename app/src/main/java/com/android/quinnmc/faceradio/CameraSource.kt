...
import com.android.quinnmc.faceradio.FrameMetadata
import com.android.quinnmc.faceradio.VisionImageProcessor
        ...
        override fun run() {
            ...
            while (true) {
                synchronized(lock) {
                    ...
                    // TODO: May crash because used to be
...
//                    // below.  We need to clear pendingFrameData to ensure that this buffer isn't
//                    // recycled back to the camera before we are done using that data.
//                    // TODO: MAY CRASH  was data = pendingFrameData
//                    data = pendingFrameData!!
//                    pendingFrameData = null
//                }
//
...
//
//        private val TAG = "MLKit - CameraSource"
//
//        /**
//         * The dummy surface texture must be assigned a chosen name. Since we never use an OpenGL context,
//         * we can choose any ID we want here. The dummy surface texture is not a crazy hack - it is
